...
void main () {
  ...
  vec3 pt1 = ballify(randomBall + nextPos, 10.0);
  pt1.z += cnoise(pt1.xy + time * 20.0) * 2.5;

  vec3 pt2 = ballify(randomBall + nextPos, 10.0);
  ...
  float flip = smoothstep(0.0, 1.0, abs(cos(time * 2.0)));
