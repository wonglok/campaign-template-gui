...
class AvatarChaserCore extends Object3D {
  constructor({
    ...
    prom.then((glb) => {
      ...
      this.makeAction('standing', `/agape-sdk/rpm/rpm-actions-locomotion/standing.fbx`).then(() => {
        // this.reset()
        // this.actions.standing.play()
      })

      this.makeAction('running', `/agape-sdk/rpm/rpm-actions-locomotion/running.fbx`).then(() => {
